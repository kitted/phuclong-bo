        ...
        <Card sx={{ borderRadius: 0, boxShadow: "none" }}>
          <SoftBox p={2}>
            ...
            <SoftTypography variant="caption" color="text" display="block" mb={1.5}>
              Tìm khách rồi chạm để lập phiếu thu
            </SoftTypography>
            <SoftInput
              value={search}
            ...
            />
            {loading && (
              <SoftTypography variant="button" display="block" textAlign="center" py={4}>
                Đang tải...
              </SoftTypography>
            )}
            {!loading && !customers.length && (
              <SoftTypography
                ...
                py={4}
              >
                Không tìm thấy khách hàng còn công nợ
              </SoftTypography>
            )}
